...
# 텍스트에서 명사, 동사, 형용사, 부사, 알파벳, 외국어 등 유의미한 단어 추출하는 함수
def extract_meaningful_words(text):
    ...
    # print(f'키워드 리스트 : {meaningful_words}')
    return meaningful_words

# extract_meaningful_words("문재인 전 대통령은 오늘(1일) 민주당, 조국혁신당, 새로운미래 등 야권 세력이 좋은 성적을 거둬야 한다고 말했습니다.\
# 문 전 대통령은 이날 오후 김정숙 여사와 함께 경남 양산 물금읍 벚꽃길을 찾아 민주당 양산갑 이재영 후보와 양산 시민들을 만났습니다.\
# 파란색 점퍼를 입고 양산시민들을 만난 문 전 대통령은 SBS 취재진에 70 평생에 이렇게 못 하는 정부는 처음 본다며 무지하고 무능하고 무도하다고 윤석열 정부를 강하게 비판했습니다.\
# 그러면서 민주당, 조국혁신당, 새로운미래, 우리 야당들이 함께 좋은 성적을 거두어서 정부가 정신 차리도록 해줘야 할 것 같다며 야권 승리 필요성을 강조했습니다.\
# 문 전 대통령은 또 내가 처음 부산사상에서 처음 국회의원 출마할 때도 사상 낙동강 변의 벚꽃길을 걷고 당선됐다며 함께한 민주당 경남 양산 이재영 후보에게 벚꽃 길 걸은 기운으로 당선되길 바란다고 격려했습니다.\
